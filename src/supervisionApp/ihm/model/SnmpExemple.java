...
public class SnmpExemple {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * the trap generation
		 */
		SnmpExemple client = new SnmpExemple("udp:192.168.201/161");
		client.start();
		/**
	...
	public String getAsString(OID oid) throws IOException {
		String result = "";
		System.out.println("getAsString =" + oid);
		...
		if(event != null){
			 ...
			 if (response != null && response.size() > 0){
				 ...
				 result = variableBinding != null ? variableBinding.toString() : "";
			 }
		}
		return result;
	}
	 ...
	 * @return
	 */
	private org.snmp4j.Target getTarget() {
		Address targetAddress = GenericAddress.parse(address);
		CommunityTarget target = new CommunityTarget();
		target.setCommunity(new OctetString("public"));
		target.setAddress((org.snmp4j.smi.Address) targetAddress);
		target.setRetries(2);
